...
import { getEthersNetwork, isSupportedChain, SUPPORTED_CHAINS, switchNetwork } from '@/networks';
...
function WalletAugmented({ children }) {
  ...
  const { connect, onPreferredNetworkChange, preferredNetwork, resetConnection, switchingNetworks } = useConnection();
