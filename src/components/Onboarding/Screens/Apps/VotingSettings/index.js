...
import { DurationFields, Header, PercentageField } from '@components/Onboarding/kit';
  ...
  switch (field) {
    case 'voteSupportRequired':
      return {
        ...
        voteMinAcceptanceQuorum: Math.min(fields.voteMinAcceptanceQuorum, value),
      };
...
function VotingSettings() {
  const { config, onBack, onNext, onConfigChange, step, steps } = useOnboardingState();
  ...
  return (
    <div>
        ...
        label={
          <Fragment>
            ...
            <Help hint="What is Support?">
              <strong>Support</strong> is the relative percentage of tokens that are required to vote “Yes” for a
              proposal to be approved. For example, if “Support” is set to 50%, then more than 50% of the tokens used to
              vote on a proposal must vote “Yes” for it to pass.
            </Help>
          </Fragment>
        }
        ...
        label={
          <Fragment>
            ...
            <Help hint="What is Minimum Approval?">
              <strong>Minimum Approval</strong> is the percentage of the total token supply that is required to vote
              “Yes” on a proposal before it can be approved. For example, if the “Minimum Approval” is set to 20%, then
              more than 20% of the outstanding token supply must vote “Yes” on a proposal for it to pass.
            </Help>
          </Fragment>
        }
        ...
        label={
          <Fragment>
            ...
            <Help hint="What is Vote Duration?">
              <strong>Vote Duration</strong> is the length of time that the vote will be open for participation. For
              example, if the Vote Duration is set to 24 hours, then tokenholders have 24 hours to participate in the
              vote.
            </Help>
          </Fragment>
        }
        ...
        label={
          <Fragment>
            ...
            <Help hint="What is Execution Delay?">
              <strong>Execution Delay</strong> is the required amount of time after a proposal passes for the proposal
              to be executed. This allows everyone to react to the outcome and make decisions before the effects of the
              vote are realised.
            </Help>
          </Fragment>
        }
        ...
        label={
          <Fragment>
            ...
            <Help hint="What is Delegated Voting Period?">
              <strong>Delegated Voting Period</strong> is the period of time, within the Vote Duration, when stewards
              can cast votes that have been delegated to them. When this period ends stewards can no longer vote.
            </Help>
          </Fragment>
        }
        ...
        label={
          <Fragment>
            ...
            <Help hint="What is Quite Ending Period?">
              <strong>Quite Ending Period</strong> is the duration before the end of a vote to detect non-quiet endings.
              Non-quiet endings are endings which involve a late swing in the vote.
            </Help>
          </Fragment>
        }
      ...
      <AdvancedSettingsModal
        ...
        handleQuiteEndingExtensionPeriodChange={handleQuiteEndingExtensionPeriodChange}
