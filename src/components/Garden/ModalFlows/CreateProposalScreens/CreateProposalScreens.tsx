        ...
        : [
            {
              ...
              graphicHeader: false,
              content: <CreateProposalRequirements agreement={agreement} staking={stakeManagement.staking} />,
            },
            {
            ...
            },
            {
              ...
              graphicHeader: false,
              content: <ActionFees agreement={agreement} onCreateTransaction={getTransactions} />,
            },
          ],
    [agreement, getTransactions, handleSetProposalData, stakingLoading, stakeManagement],
  );
