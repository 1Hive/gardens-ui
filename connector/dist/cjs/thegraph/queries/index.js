...
exports.ARBITRATOR_FEE = exports.COLLATERAL_REQUIREMENT = exports.SUPPORTER = exports.PROPOSAL = exports.ALL_PROPOSALS = exports.CONFIG = void 0;
const graphql_tag_1 = __importDefault(require("graphql-tag"));
// TODO: Filters
exports.CONFIG = (type) => graphql_tag_1.default `
  ${type} Config($id: ID!) {
    config(id: $id) {
      id
...
`;
exports.ALL_PROPOSALS = (type) => graphql_tag_1.default `
...
`;
exports.PROPOSAL = (type) => graphql_tag_1.default `
  ${type} Proposal($id: ID!) {
    proposal(id: $id) {
      id
      number
...
`;
exports.SUPPORTER = (type) => graphql_tag_1.default `
...
`;
exports.COLLATERAL_REQUIREMENT = (type) => graphql_tag_1.default `
...
`;
exports.ARBITRATOR_FEE = (type) => graphql_tag_1.default `
